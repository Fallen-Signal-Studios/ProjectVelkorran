...
void ASovTransformingWeaponVisual::SetTransitionGateActive(const bool bActive)
{
	...
	const FNarrativeGameplayTags& GameplayTags = FNarrativeGameplayTags::Get();
	FGameplayTagContainer GateTags;
	GateTags.AddTag(GameplayTags.State_Weapon_Equipping);
	GateTags.AddTag(GameplayTags.State_Weapon_BlockFiring);
