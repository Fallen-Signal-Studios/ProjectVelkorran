...
- **Conversation furniture and tablet glass:** [The Z11 furniture refinement](Validation/AurelionZ11ConversationFurniture-2026-09-24.md) uses a new measured image reference to revise the already installed one-table/six-chair visual family with quieter ivory edge work, table inlay and seat/back joinery. Blender round trip, two player-height Unreal previews, guarded M13 save/reload and two public earned CP9 M13 loads passed; all 13 native furniture collision bodies, actor transforms and M12 remained unchanged. The tablet's translucent touch glass now uses a non-Nanite static mesh, removing the incompatible-material warning. The CP9 frames show a video-memory-over-budget warning under concurrent editors, so target-PC performance is unqualified. Fresh post-fit scene interactions, close physical movement and broader 90% visual alignment remain open.

- **Witness tablet visual fit:** [The Z11 witness tablet pass](Validation/AurelionZ11WitnessTablets-2026-09-24.md) replaced five bright KitBash request-actor visuals with one Blender-authored black-stone/ivory/gold tablet after a focused image reference. Guarded Unreal fit, player-height image review and saved-map reload passed without changing actors, body collision, transforms or M12. Two fresh post-fit CP0 routes stopped at the known E1 repeatability gap after three native retries each. An older earned E4B reload reached M13 but lost the required Selene participant while the independent-assent cinematic loaded, before tablet interaction. Full post-fit scene interaction, local player movement, lighting polish, audio, packaged execution and 90% alignment remain open.

- **Observation pier and late hold sampling:** [The custom Z11 pier pass](Validation/AurelionZ11ObservationPier-2026-09-24.md) fitted a Blender-authored visual shell to the existing structural rib without changing its collision or the red/Wound/white window. A fresh visible CP0→M13 route passed M12 and M13 entry, then its input driver missed the 0.35-second final hold countdown and reported failure. The live native world nevertheless completed the final scene with 35 ordered receipts and CP9. A corrected follow-on public CP9 reload preserved the earned ending and one HUD; its rendered frame was reviewed. The driver's missed-countdown branch needs a fresh full-route retest, and the pale kiosks, dark recess lighting, close physical movement and 90% art alignment remain open.
