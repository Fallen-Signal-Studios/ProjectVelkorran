"""Load the genuine earned E4A checkpoint and inspect Tarrik's ordinary attack."""
import os
...
os.environ['SOV_CONTACT_FOLLOW_E4A'] = '1'
...
def monitor(delta):
    ...
    if status == 'probe_started':
        ...
        if route._RUN is not None and not route._RUN.done:
            return
