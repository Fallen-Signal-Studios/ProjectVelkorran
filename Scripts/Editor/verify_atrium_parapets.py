...
def verify():
    ...
    assert len(actors)==2472+atrium_canopy_count+atrium_bridge_floor_count+atrium_crown_count+atrium_crown_light_count+z06_paving_count and atrium_parapet_count==266
