...
def verify():
    ...
    assert len(actors)==2813+z06_end_count+z06_slab_count+z06_refuge_count+z06_refuge_finish_count+z06_gate_assembly_count+z06_flank_landing_count and z06_light_count==16
