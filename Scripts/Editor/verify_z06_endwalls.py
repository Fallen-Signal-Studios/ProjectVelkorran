...
def verify():
    ...
    assert len(actors)==2831+z06_slab_count+z06_refuge_count+z06_refuge_finish_count+z06_gate_assembly_count+z06_flank_landing_count+z07_paving_count+z07_wall_count+z07_light_count and z06_end_count==18
