...
def verify():
    ...
    assert len(actors)==2635+z06_ceiling_count+z06_side_count+z06_light_count+z06_end_count+z06_slab_count+z06_refuge_count+z06_refuge_finish_count and z06_paving_count==126
