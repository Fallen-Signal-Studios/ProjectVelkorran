...
code=code.replace('len(actors)==2509',"len(actors)==2843+sum(a.get_actor_label().startswith(('KIT_Z07_Paving_','KIT_Z07_Wall_','KIT_Z07_Uplight_')) for a in actors)").replace('Z06','Z07').replace('z06','z07')
