...
def verify():
    ...
    assert len(actors)==2797+z06_light_count+z06_end_count+z06_slab_count+z06_refuge_count+z06_refuge_finish_count+z06_gate_assembly_count+z06_flank_landing_count+z07_paving_count and z06_side_count==36
