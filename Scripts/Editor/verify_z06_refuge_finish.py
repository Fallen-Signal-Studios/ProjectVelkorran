...
def verify():
    ...
    assert len(actors)==2837+z06_gate_assembly_count+z06_flank_landing_count+z07_paving_count+z07_wall_count+z07_light_count+z08_paving_count+z08_court_count and z06_refuge_finish_count==3
