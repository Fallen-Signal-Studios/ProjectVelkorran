...
def verify():
    verify_floors()
    assert len(actors)==2493+atrium_crown_light_count+z06_paving_count+z06_ceiling_count+z06_side_count+z06_light_count+z06_end_count and atrium_crown_count==9
