...
def verify():
    ...
    assert len(rows)==2 and len(actors)==2843+z07_paving_count+z07_wall_count+z07_light_count+z08_paving_count and not unreal.EditorLoadingAndSavingUtils.get_dirty_map_packages()
