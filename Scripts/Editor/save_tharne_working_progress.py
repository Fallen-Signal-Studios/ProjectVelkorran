...
unreal.EditorAssetLibrary.set_metadata_tag(asset, 'SovereignArtStatus',
    'WIP: Orlando baseline; beard and mustache removed; Short Messy dark-brown groom selected. '
    'Both eyes use the dark-brown preset. '
    'Initial chin sculpt/transform review remains too close to the baseline; '
    'face refinement, skin, mission wardrobe, rig and runtime integration pending. '
