...
/**Base class for states and branches in the quests state machine*/
 UCLASS()
 class NARRATIVEARSENAL_API UQuestNode : public UNarrativeNodeBase
 {
...
class NARRATIVEARSENAL_API UQuestState : public UQuestNode
{
	GENERATED_BODY()
...
class NARRATIVEARSENAL_API UQuestBranch : public UQuestNode
{
