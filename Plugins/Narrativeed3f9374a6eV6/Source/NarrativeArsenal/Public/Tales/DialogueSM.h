...
/**Base class for states and branches in the Dialogues state machine*/
 ...
 class NARRATIVEARSENAL_API UDialogueNode : public UNarrativeNodeBase
 {
...
class NARRATIVEARSENAL_API UDialogueNode_NPC : public UDialogueNode
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class NARRATIVEARSENAL_API UDialogueNode_Player : public UDialogueNode
{
	GENERATED_BODY()
...
public:
	...
	/** The specific character who we want to say this line. Only needs to be set in a networked game, if empty will default to the dialogue owning pawn. */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Details - Player Dialogue Node")
	TObjectPtr<class UPlayerDefinition> PlayerOverride;
