...
/** A special type of gameplayeffectitem that can be applied to anything with a Poisonable fragment, and isnt intended for the player to consume. */
UCLASS()
class NARRATIVEARSENAL_API UPoisonItem : public UGameplayEffectItem
{
	GENERATED_BODY()
