 ...
 */
UCLASS()
class NARRATIVEARSENAL_API ANarrativePlayerState : public APlayerState, public IAbilitySystemInterface, public INarrativeTeamAgentInterface, public INarrativeCharacterOwner
{
	GENERATED_BODY()
	
public:

	ANarrativePlayerState(const FObjectInitializer& ObjectInitializer);
