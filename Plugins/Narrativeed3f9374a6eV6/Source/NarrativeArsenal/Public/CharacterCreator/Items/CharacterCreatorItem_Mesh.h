...
public:
	...
	//The base mesh info - can be configured by the options set 
	UPROPERTY(BlueprintReadWrite, EditDefaultsOnly, Category = "Mesh")
	FCharacterCreatorAttribute_Mesh MeshAttributes; 
	...
	//The morphs options that can be controlled 
	UPROPERTY(BlueprintReadWrite, EditDefaultsOnly, Category = "Mesh")
