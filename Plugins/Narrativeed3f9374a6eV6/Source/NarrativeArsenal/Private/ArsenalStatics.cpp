...
TArray<FString> UArsenalStatics::GetMonitorNames()
{
	...
	for (auto& Display : DisplayMetrics.MonitorInfo)
	{
	...
	//TODO fetch friendly vendor names for monitor. 
