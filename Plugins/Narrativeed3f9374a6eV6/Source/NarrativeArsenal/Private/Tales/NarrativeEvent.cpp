...
UNarrativeEvent::UNarrativeEvent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	PartyEventPolicy = EPartyEventPolicy::Party;
}

void UNarrativeEvent::OnActivate_Implementation(APawn* Target, APlayerController* Controller, class UTalesComponent* NarrativeComponent)
{
	ExecuteEvent(Target, Controller, NarrativeComponent);
}

void UNarrativeEvent::OnDeactivate_Implementation(APawn* Target, APlayerController* Controller, class UTalesComponent* NarrativeComponent)
{
