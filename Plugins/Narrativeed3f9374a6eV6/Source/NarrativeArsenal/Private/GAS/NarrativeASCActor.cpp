...
class UAbilitySystemComponent* ANarrativeASCActor::GetAbilitySystemComponent() const
{
...
void ANarrativeASCActor::InitializeAttributes()
{
	...
	AbilitySystemComponent->OnDeathStateChanged.AddUniqueDynamic(this, &ThisClass::HandleDeath);

	AbilitySystemComponent->bStartupEffectsApplied = true; 
}

void ANarrativeASCActor::HandleDeath_Implementation(AActor* KilledActor, UNarrativeAbilitySystemComponent* KilledActorASC, const bool bIsDead)
{
