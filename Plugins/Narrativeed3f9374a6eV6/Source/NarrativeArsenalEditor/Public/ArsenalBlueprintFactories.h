...
class UNPCDefinitionFactory : public UFactory
{
	...
	bool bCreateAppearanceAsset = false;
	
	UPROPERTY(EditAnywhere, Category="NPC|Level")
	int32 MinLevel = 1;
	...
	bool bCreateDialogueAsset = false;

	UPROPERTY(EditAnywhere, Category="NPC|Dialogue")
	bool bCreateTaggedDialogue = false;

	UPROPERTY(EditAnywhere, Category="NPC|Dialogue", meta=(EditCondition="bCreateTaggedDialogue", EditConditionHides))
	bool bAutofillTaggedDialogue = false;
};
