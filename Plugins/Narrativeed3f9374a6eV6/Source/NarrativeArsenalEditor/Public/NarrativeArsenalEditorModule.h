...
public:
	...
	void RegisterNonGameToolbarMenus();
	void UnregisterNonGameToolbarMenus();

	static TSharedPtr<FNarrativeProjectSetupHandler> GetProjectSetup();
...
private:
	...
	FDelegateHandle NonGameToolMenuStartupHandle;
	TSharedPtr<FNarrativeProjectSetupHandler> NarrativeProjectSetup;
	TSharedPtr<FNarrativeEditorSaveMenus> NarrativeEditorSaveMenus;
};
