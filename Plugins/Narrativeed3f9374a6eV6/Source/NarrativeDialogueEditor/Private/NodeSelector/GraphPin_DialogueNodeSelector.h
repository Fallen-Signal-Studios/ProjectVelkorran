...
#include "Tales/NarrativeNodeSelector.h"

class SGraphPin_DialogueNodeSelector final : public SGraphPin_NodeSelectorBase
{
	FDialogueNodeSelector SelectorStruct;
	
public:
	
	SLATE_BEGIN_ARGS(SGraphPin_DialogueNodeSelector) {}
	SLATE_END_ARGS()
...
struct FPinFactoryDialogueNodeSelector : public FGraphPanelPinFactory
{
public:
