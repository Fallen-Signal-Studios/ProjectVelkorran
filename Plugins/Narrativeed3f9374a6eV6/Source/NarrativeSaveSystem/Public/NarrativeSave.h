...
public:
	...
	bool IsValid() const {return !PawnData.ActorName.IsNone();};
};
...
public:
	...
	//Not currently implemented yet - in future we want to save all actor records per map.
	//UPROPERTY()
