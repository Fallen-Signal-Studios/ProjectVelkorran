...
UQuestEditorSettings::UQuestEditorSettings()
{
	...
	auto QuestNodeUserWidgetFinder = ConstructorHelpers::FClassFinder<UQuestNodeUserWidget>(TEXT("/Script/UMGEditor.WidgetBlueprint'/NarrativePro/Pro/Editor/UI/Widgets/Tales/WBP_DefaultQuestNode.WBP_DefaultQuestNode_C'"));
	if (QuestNodeUserWidgetFinder.Succeeded())
	{
		DefaultQuestWidgetClass = QuestNodeUserWidgetFinder.Class;
	}

	QuestTaskSearchPaths.Add("/NarrativePro/Pro/Core/Tales/Tasks/");	
